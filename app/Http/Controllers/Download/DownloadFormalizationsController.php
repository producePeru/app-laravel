...
class DownloadFormalizationsController extends Controller
{
    ...
    public function exportAsesories(Request $request)
    {
        ...
        $advisories = Advisory::with([
            ...
            'user.profile:id,user_id,name,lastname,middlename,notary_id',
            'user.profile.notary:id,name',
            'people:id,name,lastname,middlename,country,birthday,hasSoon,sick,phone,email,typedocument_id,gender_id',
        ...
        $result = $advisories->map(function ($advisory) use (&$index) {
            ...
            return [
                ...
                'asesor' => $asesor,
                'region_cde' => optional($advisory->cde)->city,
                'provincia_cde' => optional($advisory->cde)->province,
                'distrito_cde' => optional($advisory->cde)->district,
                'tipo_documento' => $advisory->people->typedocument->avr,
                'numero_documento' => $advisory->dni,
                'nombre_pais' => $advisory->people->country,
