...
class CertificadoEnviadoMail extends Mailable
{
    ...
    public function build()
    {
        ...
        return $this->view('emails.emailCertificadoEnviado')
            ...
            ->attach($filePath)
            ->cc(['tuempresa_temp265@produce.gob.pe', 'ozambrano@produce.gob.pe']);        // capacitaciones_tuempresa@produce.gob.pe || tuempresa_temp265@produce.gob.pe - 'capacitaciones_tuempresa@produce.gob.pe'
    }
}
